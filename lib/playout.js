module.exports = function (ccg) {
	...
	// ccg.add
	// ---
	// Record START (FFMPEG) Function; 04.06.18 Nicolas Brantschen
	// 
	ccg.prototype.add = function (channel, cb) {
		this.sendCommand("ADD " + channel, cb);
	};
	
	// ---
	// ccg.remove
	// ---
	// Record STOP (FFMPEG) Function; 04.06.18 Nicolas Brantschen
	// 
	ccg.prototype.remove = function (channel, cb) {
		this.sendCommand("REMOVE " + channel, cb);
	};
